  ...
  return (
    <View style={styles.container}>
      ...
      <View style={{ flexDirection: "row", marginLeft: 10 }}>
        ...
        <Text style={{ fontSize: 12, marginLeft: 3 }}>{convertDate()}</Text>
      </View>
      ...
      <View style={styles.containerRecord}>
        ...
        >
          <Text style={styles.itemTitle}>Pace</Text>
        ...
        <View style={styles.itemRecord}>
          <Text style={styles.itemTitle}>Caloies</Text>

          <Text style={styles.itemContent}>{record.calo} Kcal</Text>
        </View>
      </View>
      ...
      >
        ...
        {
          <Marker coordinate={map.routes[0][0]} anchor={{ x: 0, y: 1 }}>
