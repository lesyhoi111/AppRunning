      ...
      <FontLoader>
        ...
        >
          <TextInput
            ...
            keyboardType={
              unit != "" ? "numeric" : title != "Phone" ? "default" : "numeric"
            }
        ...
        {unit != "" ? <Text style={styles.title}>{unit}.</Text> : null}
      </FontLoader>
    </View>
  );
};
