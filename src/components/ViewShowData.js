  ...
  return (
    ...
    >
      ...
      <View style={{ flexDirection: "row", marginBottom: -1 }}>
        ...
        <View style={styles.viewTextData}>
          <Text style={styles.textData}>
            {get_distance(dataThisMonth).toFixed(2)}
          </Text>
        </View>
        <View style={styles.viewTextData}>
          <Text style={styles.textData}>
            {get_distance(dataLastMonth).toFixed(2)}
          </Text>
        </View>
      </View>
      ...
      <View style={{ flexDirection: "row" }}>
        ...
        <View style={styles.viewTextData}>
          <Text style={styles.textData}>
            {get_avg_pace(dataThisMonth).toFixed(2)}
          </Text>
        </View>
        <View style={styles.viewTextData}>
          <Text style={styles.textData}>
            {get_avg_pace(dataLastMonth).toFixed(2)}
          </Text>
        </View>
      </View>
      <View style={{ flexDirection: "row", marginTop: -1 }}>
        ...
        <View style={styles.viewTextData}>
          <Text style={styles.textData}>
            {get_time(dataThisMonth).toFixed(0)}
          </Text>
        </View>
        <View style={styles.viewTextData}>
          <Text style={styles.textData}>
            {get_time(dataLastMonth).toFixed(0)}
          </Text>
        </View>
      </View>
      <View style={{ flexDirection: "row", marginTop: -1 }}>
        ...
        <View style={styles.viewTextData}>
          <Text style={styles.textData}>
            {get_calories(dataThisMonth).toFixed(0)}
          </Text>
        </View>
        <View style={styles.viewTextData}>
          <Text style={styles.textData}>
            {get_calories(dataLastMonth).toFixed(0)}
          </Text>
        </View>
      </View>
      <View style={{ flexDirection: "row", marginTop: -1 }}>
        ...
        <View style={styles.viewTextData}>
          <Text style={styles.textData}>
            {get_count_activities(dataThisMonth)}
          </Text>
        </View>
        <View style={styles.viewTextData}>
          <Text style={styles.textData}>
            {get_count_activities(dataLastMonth)}
          </Text>
        </View>
      </View>
    </View>
